...
function FlowCanvas() {
    ...
    useEffect(() => {
        try {
            ...
            // 3. Compute connections for each node based on ALL edges (store labels, not IDs)
            const nodeConnections = {};
            safeInitialEdges.forEach(edge => {
        ...
        <div className="app-container">
            <header className="app-header">
                ...
                <div className="header-actions">
                    <ThemeToggle />
                    <a
                        href="https://github.com/mooserson/IEP_504_FBA_BIP_Explainer"
                        target="_blank"
                    ...
                    <a
                        href="https://www.linkedin.com/in/pmcathey/"
                        target="_blank"
                        rel="noopener noreferrer"
